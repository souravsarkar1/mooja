...
export default function ChatSidebar({ friends, pendingRequests, onSelectFriend, onRefresh, mobile }: any) {
    ...
    return (
        <div className={`${mobile ? 'flex-1' : 'w-80 border-r hidden md:flex'} flex flex-col h-full bg-slate-50/50`}>
            {!mobile && (
                ...
                <div className="px-4 py-3">
                    <div className="relative group">
                        ...
                        <Input
                            ...
                            className="pl-9 h-11 bg-white border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-50 transition-all text-sm"
                            value={searchQuery}
                            onChange={(e) => setSearchQuery(e.target.value)}
                            onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
                        />
            ...
            {searchResults.length > 0 && (
                <div className="mx-4 mb-4 bg-white border border-gray-200 rounded-xl p-3 shadow-xl space-y-3 mt-2 animate-in fade-in slide-in-from-top-2 z-20">
                    <div className="flex items-center justify-between">
                    ...
                    {friends.map((friend: any) => (
                        ...
                        >
                            <div className="relative">
                                <Avatar className="h-12 w-12 md:h-11 md:w-11 ring-2 ring-white">
