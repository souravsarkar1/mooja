...
export default function FriendManagement({ pendingRequests, onRefresh }: any) {
    ...
    return (
        <div className="flex-1 overflow-hidden flex flex-col bg-gray-50/50 p-4 md:p-8">
            <div className="max-w-4xl mx-auto w-full space-y-8">
                {/* Search Header */}
                <div className="flex flex-col gap-4">
                    <h1 className="text-3xl font-bold text-gray-900 leading-tight">Find Friends</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
                    ...
                    <div className="space-y-4">
                        ...
                        <ScrollArea className="h-[400px] rounded-xl border bg-white shadow-sm p-4">
                            {pendingRequests.length === 0 && (
                            ...
                            <div className="space-y-4">
                                {pendingRequests.map((req: any) => (
                                    <div key={req._id} className="flex items-center justify-between p-3 rounded-lg border group hover:border-blue-200 transition-all">
                                        ...
                                        <div className="flex gap-2">
                                            <Button size="sm" className="bg-blue-600 hover:bg-blue-700" onClick={() => acceptRequest(req._id)}>
                                                Confirm
                                            </Button>
                    ...
                    {/* Right Column: Discover People */}
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold">People You May Know</h2>
                        <ScrollArea className="h-[400px] rounded-xl border bg-white shadow-sm p-4">
                            <div className="space-y-4">
                                {(searchResults.length > 0 ? searchResults : suggestions).map((u: any) => (
                                    <div key={u._id} className="flex items-center justify-between p-3 rounded-lg border hover:border-blue-200 transition-all">
                                        <div className="flex items-center gap-3">
                                        ...
                                        <Button
                                            size="sm"
                                            variant="secondary"
                                            className="gap-1.5 h-8 px-3 text-blue-600 bg-blue-50 hover:bg-blue-100 border-none"
